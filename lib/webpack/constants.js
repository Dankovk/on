...
exports.DEV_SERVER_PROXY_CONFIG = {
	'/updated': 'http://localhost:4112',
	'/theatre.json': 'http://localhost:4112',
	'/components': 'http://localhost:4112'
};
...
exports.EXCLUDE_SOURCE_MAPS = [
	...
	path.resolve(__dirname, '../../packages/theatre/node_modules/@angular'),
	path.resolve(__dirname, '../../packages/theatre/node_modules/rxjs')
];
