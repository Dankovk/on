...
const URLS = {
  [ANIMAL_TYPES.LION]: /*'/api/animals/lions',*/ 'http://www.mocky.io/v2/58dfb6661000003b03cc15c8',
  [ANIMAL_TYPES.ELEPHANT]: /*'/api/animals/elephants',*/ 'http://www.mocky.io/v2/58dfb54c1000000403cc15c7',
};
